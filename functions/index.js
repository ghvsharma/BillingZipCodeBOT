...
const BankAccHandler = require(functions['bank_account_number_task'].path);
...
console.log("currenttask"+ CurrentTask);
 ...
 switch (CurrentTask) {
   ...
   case 'bank_account_number':
     ...
     await BankAccHandler.bank_account_number_task(context, event, callback,responseBuilder.RB);
     break;
     case 'agent_transfer':
